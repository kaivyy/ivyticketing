...
UPDATE event_categories SET
    ...
    bib_prefix = $7, min_age = $8, max_order_per_user = $9,
    distance_km = $10, cutoff_time = $11, pricing_tiers = $12,
    updated_at = now()
WHERE id = $1 AND event_id = $13
RETURNING *;
